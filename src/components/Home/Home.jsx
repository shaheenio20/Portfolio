    ...
    <div className="py-10 lg:py-25 bg-base-200 mb-8 overflow-hidden">
      <div className="animate-fade-in-up">
        <div className="hero min-h-screen">
          <div className="hero-content flex-col lg:flex-row-reverse w-11/12 lg:w-10/12 mx-auto lg:py-10 py-10 justify-center gap-8 lg:gap-12">
            ...
            <div className="w-full lg:w-1/2 animate-fade-in-up text-center lg:text-left">
              <div className="">
                ...
                <h1 className="lg:text-6xl text-3xl font-bold pt-3 h-[120px] lg:h-auto">
                  <Typewriter
                    text="Hello, My Name Is MD Shaheenur Rashid"
                    delay={100}
                  />
                </h1>
                <p className="py-6 text-lg text-base-content/80">
                  ...
                  specialize in MongoDB, Express.js, React, and Node.js, with a
                  strong focus on clean code, performance, and creating seamless
                  user experiences.
                </p>
                <button
                  className="btn btn-primary rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                ...
                {showInfo && (
                  <div className="mt-6 bg-base-100 p-6 rounded-xl shadow-xl text-base-content animate-zoom-in border border-base-300  text-left">
                    <p className="mb-2">
                      <strong className="text-primary">ID: </strong>232-134-020
                    </p>
                    <p className="mb-2">
                      <strong className="text-primary">Batch: </strong>5th
                    </p>
                    <p className="mb-2">
                      <strong className="text-primary">Name: </strong> MD
                      Shaheenur Rashid
                    </p>
                    <p className="mb-2">
                      <strong className="text-primary">CGP: </strong>3.65 out of
                      4.00
                    </p>
                    <p className="mb-2">
                    ...
                    <p className="mb-2">
                      <strong className="text-primary">University: </strong>{" "}
                      Metropolitan University
                    </p>
                    <p className="mb-2">
                      <strong className="text-primary">Email: </strong>{" "}
                      rashidcoder238@gmail.com
                    </p>
                  </div>
                )}
                <div className="py-12">
      ...
      <div className="w-11/12 lg:w-10/12 mx-auto py-16 bg-base-100 mb-8 rounded-2xl shadow-xl animate-fade-in-up">
        <div className="text-center lg:w-[600px] w-[300px] mx-auto space-y-4 px-4 mb-16">
          <h1 className="lg:text-5xl text-3xl font-bold mb-5 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
            Web Development
          </h1>
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8 px-6">
          {[lap1, lap2, lap3].map((img, index) => (
            <div
              key={index}
              className="card w-full bg-base-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group overflow-hidden"
            >
              ...
              <div className="card-body items-center text-center space-y-2">
                <h3 className="text-sm font-bold text-secondary tracking-widest">
                  WEB DESIGN
                </h3>
      ...
      <div className="bg-neutral text-neutral-content rounded-t-3xl mt-10 animate-fade-in-up">
        <div className="w-11/12 lg:w-10/12 mx-auto py-24 px-5">
          <h1 className="lg:text-5xl text-3xl font-bold text-center px-4 mb-16 animate-zoom-in">
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-12 items-center">
            <div className="space-y-6 lg:pr-10">
              ...
              <div>
                <button
                  className="btn btn-primary mt-8 rounded-xl shadow-lg hover:shadow-primary/50 transition-all duration-300 hover:-translate-y-1"
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-6">
              {[
                ...
                },
                {
                  icon: TbAnalyze,
                  title: "2. Analyze",
                  desc: "Crafting clean, thoughtful interfaces where form flows seamlessly into function.",
                },
                {
                  icon: CiEdit,
                  title: "3. Design",
                  desc: "I design seamless digital experiences with precision, purpose, and elegance.",
                },
                {
                  icon: MdLaunch,
                  title: "4. Launch",
                  desc: "Thoughtful design meets performance-driven, responsive development.",
                },
              ].map((item, index) => (
                <div
                  key={index}
                  className="w-full bg-base-200/10 backdrop-blur-sm border border-neutral-content/10 hover:bg-primary hover:text-primary-content transition-all duration-500 rounded-2xl p-8 flex flex-col items-center group shadow-lg hover:shadow-primary/30 hover:-translate-y-2"
                >
